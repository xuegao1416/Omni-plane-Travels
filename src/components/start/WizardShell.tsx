...
import { isProfessionBinding,resolveProfessionBinding } from '../../data/professions';
...
export default function WizardShell({
  step, setStep, onBackToMenu, title, subtitle,
  selectedWorld,
  ...
  const resolvedProfessionConfig = professionModule ? resolveProfessionBinding(professionModule.moduleConfig) : undefined;
  ...
  return (
    <div className="creation-ritual-shell" aria-label="世界降临仪式">
      ...
      <div className="creation-ritual-shell__body">
        <aside className="creation-ritual-shell__steps" aria-label="创建步骤" style={{ gridTemplateColumns: `repeat(${stepLabels.length}, minmax(0, 1fr))` }}>
