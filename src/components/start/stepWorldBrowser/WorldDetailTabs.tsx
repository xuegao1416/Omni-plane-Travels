...
export function SystemsTab({ world }: { world: WorldDef }) {
  ...
  const MODULE_NAMES: Record<string, string> = { stat: '数值属性', progression: '成长体系', survival: '生存资源', business: '经营资产', dice: '骰子检定', talent: '天赋体系', profession: '职业体系', combat: '图形化战斗', simulation: '世界动态' };
