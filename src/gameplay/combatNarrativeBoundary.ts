...
const ACTIVE_ASSAULT_RE = /(?:遭(?:到|遇)(?:伏击|围攻|包围|袭击)|被.{0,6}(?:伏击|围攻|包围|袭击)|(?:伏击者|埋伏者|袭击者|追杀者|追兵|敌人|敌军|守卫|士兵|怪物).{0,20}(?:现身|发动|扑向|冲来|逼近|堵住|拔(?:刀|剑)|挥.{0,4}(?:刀|剑|拳)|举枪|瞄准|开枪|射击)|(?:双方|彼此).{0,16}(?:剑拔弩张|一触即发|即将(?:开战|交战|交锋)|进入战斗姿态)|(?:战斗|交锋|交战).{0,8}(?:一触即发|即将开始)|(?:即将|马上|眼看就要).{0,8}(?:开战|交战|交锋|迎击)|朝(?:着)?你.{0,12}(?:砍|劈|刺|射|扑|开枪)|向你.{0,12}(?:砍|劈|刺|射|扑|开枪)|子弹.{0,10}(?:飞来|袭来))/;
