...
叙事指引：当玩家进行经营活动时，必须在正文中明确写出以下信息，供后台系统提取：
- 收购资产：写出资产名称、类型、描述、价格，例如"你花了5000金币盘下了城东的一家小酒馆"（使用该世界对应的货币名称）
- 升级资产：写出升级内容和费用，例如"你花了2000金币把酒馆从1级升到2级，扩建了包间"（使用该世界对应的货币名称）
- 出售资产：写出售价和原因
- 资金变更：涉及资金变动时写出具体金额
- 无经营活动时：不要提及资金或资产数字

★ 不要用模糊表述（如"你收购了一些资产"），必须写出具体名称和金额。`;
